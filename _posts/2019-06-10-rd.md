...
### Daily Report Module
 ...
 One large part of my project involvement was designing a user-friendly interface that allowed end users to easily input daily report data. Without user support
