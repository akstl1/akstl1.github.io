...
Construction Management companies like Commodore make money by charging a fee for their services. Commodore has a target fee goal for each project, and this gets aggregated into an overall company target. To monitor company fee, I built a line chart that will allow leaders to track how well the company is performing against overall fee goals and deep dive into projects that are bringing in less fee than anticipated.
    
To do this I built two measures:

The first measure was the target fee for a project, which was a single number input to one of our databases. I calculated this as a percentage of the total project value.

The second measure was the current fee projection for a project, which was updated any time a new change order or other contract alteration was entered into our databases. I determined all the relevant entry fields and filters.

Next, I plotted these lines on one line plot over the life of a project. This will allow company leaders to compare target and actual fee for any project and any period.
