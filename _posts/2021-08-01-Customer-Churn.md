...
Note that the code for this project can also be found at the following Github repository: <a href="https://github.com/akstl1/Supervised-Learning-Capstone>Supervised-Learning-Capstone"here<a/>. 
