...
In January 2026 I took part in the Power BI Data Viz Championships, sponsored by Microsoft. The goal of this competition's first week was to compare livability in a fictional city, Briarport, against eleven peer cities using five livability metrics.

The analysis was meant to be for city planners, policy analysts, and community stakeholders as these groups looked at Briarport's strengths and weaknesses and prioritize future urban planning investments and initiatives.
...
Briarport's strongest performance in the last decade was in housing affordability, in which it ranked first consistently, and in emissions reduction, with the city having the largest reduction of any of its peers in this period.
...
Data source: The data for this project was provided by Miscrosoft, and encoded in Power BI directly.
...
- Livability Scores - Annual scores for each city with the following metrics: housing affordability, green space, transit, emissions, and an overall composite score
...
## ---- Peer comparison ----
To compare Briarport to its peers, I created bar charts comparing Briarport to its peers over a ten year window and used color to easily show users how Briarport measured in the rankings.
...
And finally I used bookmarks that let users switch between viewing Briarport's 2024 ranking, ten-year trend, and year-by-year ranking change for the selected metric.

I believed that the combination of charts and chart capabilities above let the user digest a manageable amount of information in meaningful ways that could actually influence decisions and spark discussion on how to improve city planning going forward.
...
To do so, I created a line chart and used small multiples to dissect how cities in each region performed in each metric. I overlaid Briarport in each region as well to understand how it compared to each city in this new context.
...
This type of regional context allowed me to take away some biases that city-only measurements yielded, and provided a more wholistic overview of Briarport's strengths and weaknesses in a broader environmentally informed context.
